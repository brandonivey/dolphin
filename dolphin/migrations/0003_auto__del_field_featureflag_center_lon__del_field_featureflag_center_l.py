...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeatureFlag.center_lon'
        db.delete_column('dolphin_featureflag', 'center_lon')

        # Deleting field 'FeatureFlag.center_lat'
        db.delete_column('dolphin_featureflag', 'center_lat')

        # Adding field 'FeatureFlag.center'
        db.add_column('dolphin_featureflag', 'center',
                      self.gf('geoposition.fields.GeopositionField')(max_length=42, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FeatureFlag.center_lon'
        db.add_column('dolphin_featureflag', 'center_lon',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FeatureFlag.center_lat'
        db.add_column('dolphin_featureflag', 'center_lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FeatureFlag.center'
        db.delete_column('dolphin_featureflag', 'center')
